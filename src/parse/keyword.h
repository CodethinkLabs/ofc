...
typedef enum
{
	...
	PARSE_KEYWORD_EXIST,
	PARSE_KEYWORD_OPENED,
	PARSE_KEYWORD_NAMED,
	PARSE_KEYWORD_SEQUENTIAL,
	PARSE_KEYWORD_DIRECT,
	PARSE_KEYWORD_FORMATTED,
	PARSE_KEYWORD_UNFORMATTED,
	PARSE_KEYWORD_NUMBER,
	PARSE_KEYWORD_NEXTREC,
